...
update msg_ model_ =
    case ( msg_, model_ ) of
        ...
        ( Msg.YourLibrary msg, Model.YourLibrary params model ) ->
            pages.yourLibrary.update params msg model
...
view model_ =
    case model_ of
        ...
        Model.YourLibrary params model ->
            pages.yourLibrary.view params model
...
subscriptions model_ =
    case model_ of
        ...
        Model.YourLibrary params model ->
            pages.yourLibrary.subscriptions params model
...
pages :
    ...
    , yourLibrary : Bundle Gen.Params.YourLibrary.Params Pages.YourLibrary.Model Pages.YourLibrary.Msg
    , notFound : Static Gen.Params.NotFound.Params
    }
pages =
    { home_ = bundle Pages.Home_.page Model.Home_ Msg.Home_
    , search = bundle Pages.Search.page Model.Search Msg.Search
    , yourLibrary = bundle Pages.YourLibrary.page Model.YourLibrary Msg.YourLibrary
